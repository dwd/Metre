...
namespace Metre::Router {
    ...
    void register_session_domain(std::string const &dom, NetSession const &);
    ...
    void register_stream_id(std::string const &, NetSession const &);
    ...
    void run(std::function<bool()> const &);
