...
namespace Metre {
	...
	namespace DNS {
		...
		class Address {
		public:
			std::vector<unsigned long> addr4;
		...
		class Resolver {
		public:
			typedef sigslot::signal<sigslot::thread::mt, Srv> srv_callback_t;
			typedef sigslot::signal<sigslot::thread::mt, Address> addr_callback_t;
